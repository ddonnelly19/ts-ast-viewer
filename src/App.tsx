		...
		<div id="App" data-theme={state.editorTheme}>
			...
			<div id="AppBody">
				<Allotment minSize={50}>
					<Allotment.Pane preferredSize="33%">{getCodeEditorArea()}</Allotment.Pane>
			...
			return (
				<components.CodeEditor
					...
					onClick={(range) => {
						...
						const descendant = getDescendantAtRange(state.options.treeMode, compiler.sourceFile, range, compiler.api);
